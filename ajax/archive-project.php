...
/**
 * AJAX Handler: Archive/Restore Project
 *
 * Toggles a project's status between 'active' and 'archived'.
 * Verifies ownership before modification. Returns the updated status.
 */
